                ...
                <div class="box-body">
                    <table id="tags-table" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th class="hidden-sm">品牌名稱</th>
                            <th class="hidden-sm">名稱</th>
                            <th class="hidden-sm">說明</th>
                ...
                <script>
                    $(function () {
                            ...
                            columnDefs: [
                                {
                                    ...
                                    "render": function (data, type, row) {
                                        ...
                                        //編輯
                                        if (row_edit) {
                                            str += '<a style="margin:3px;" href="{{ route('admin.' .  $resourceName . '.edit', ['id' => '__id']) }}" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 編輯</a>'.replace('__id', row['id']);
                                        }
                        ...
                        $("table").delegate('.delBtn', 'click', function () {
                            ...
                            $('.deleteForm').attr('action', '{{ route('admin.' . $resourceName . '.destroy', ['id' => '__id']) }}'.replace('__id', id));
                            $("#modal-delete").modal();
                        });
