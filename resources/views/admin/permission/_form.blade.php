...
<div class="form-group">
    <label for="tag" class="col-md-3 control-label">權限規則</label>
    <div class="col-md-6">
...
<div class="form-group">
    <label for="tag" class="col-md-3 control-label">權限名稱</label>
    <div class="col-md-6">
...
{{--圖標修改--}}
    ...
    <div class="form-group">
    <label for="tag" class="col-md-3 control-label">圖標</label>
    <div class="col-md-6">
        <!-- Button tag -->
...
@endif
<div class="form-group">
    <label for="tag" class="col-md-3 control-label">權限概述</label>
    <div class="col-md-6">
