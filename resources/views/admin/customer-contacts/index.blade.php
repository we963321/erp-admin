                ...
                <div class="box-body">
                    <table id="tags-table" class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <th class="hidden-sm">客戶名稱</th>
                            <th class="hidden-sm">主旨</th>
                            <th class="hidden-sm">備註</th>
                            ...
                            columnDefs: [
                                {
                                    ...
                                    "render": function (data, type, row) {
                                        ...
                                        //編輯
                                        if (row_edit) {
                                            str += '<a style="margin:3px;" href="{{ route('admin.' .  $resourceName . '.edit', ['id' => '__id']) }}" class="X-Small btn-xs text-success "><i class="fa fa-edit"></i> 查看內容</a>'.replace('__id', row['id']);
                                        }
