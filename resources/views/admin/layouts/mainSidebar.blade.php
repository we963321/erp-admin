    ...
    <section class="sidebar">
      ...
      {{--  <div class="user-panel">
            ...
            <div class="pull-left info">
                ...
                <!-- Status -->
                <a><i class="fa fa-circle text-success"></i> 在線</a>
            </div>
        </div>
--}}
                ...
                <li class="treeview  @if(in_array($v['id'],$comData['openarr'])) active @endif">
                    ...
                    <ul class="treeview-menu">
                        @foreach($comData[$v['id']] as $vv)
                            <li @if(in_array($vv['id'],$comData['openarr'])) class="active" @endif><a href="{{URL::route('admin.' . $vv['name'])}}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-circle-o"></i>{{$vv['label']}}</a></li>
                        @endforeach
                    </ul>
                </li>
            @endforeach
