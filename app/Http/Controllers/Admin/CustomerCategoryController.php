...
class CustomerCategoryController extends Controller
{
    ...
    {  
        ...
        try{
            ...
            event(new \App\Events\userActionEvent('\App\Models\CustomerCategory', $customer_category->id, 1, '新增了會員種類' . $customer_category->name));
    ...
    public function update(Requests\CustomerCategoryUpdateRequest $request, $id)
    {
        ...
        try{
            ...
            event(new \App\Events\userActionEvent('\App\Models\CustomerCategory', $customer_category->id, 3, '編輯了會員種類' . $customer_category->name));
